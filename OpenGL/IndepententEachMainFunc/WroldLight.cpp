...
int main()
{
	...
	// ------------------------------------
	//Shader lightShader("diffuse_tex_vertex.glsl", "world_point_light_frag.glsl");
	Shader lightShader("diffuse_tex_vertex.glsl", "world_spot_light_frag.glsl");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//lightShader.setVec3("light.direction", -0.2f, -1.0f, 0.5f);
